...
global.location="New Delh,INDIA."
...
global.caption = process.env.CAPTION || global.caption || "© KINGB2KBOT" 


global.devs = "+919654970780" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "9654970780";
...
module.exports = {
  ...
  caption : global.caption || "KING B2K BOT ✓" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ GlobalTechInfo ® 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@GlobalTechInfo"),
